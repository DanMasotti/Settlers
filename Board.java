...
/*
 * tedious GUI so that users can see what happens in the game
 * I modelled the board after the default catan board and didn't 
 * worry about randomized boards
 */
public class Board {
	...
	/*
	 * helper for the graphics and the datastructure
	 */
